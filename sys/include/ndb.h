...
enum
{
	...
	Ndbhead=	1<<0,	/* first db in chain */
	Ndbcat=	1<<1,	/* ndb catted */
	Ndbnodel=	Ndbhead|Ndbcat,
				/* keep if missing from database= line */
};
...
struct Ndb
{
	...
	uvlong		length;		/* length of db file */
	...
	uint		flags;		/* various and sundry attrs */
};
