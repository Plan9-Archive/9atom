...
/* hcchar */
	...
	Eptype		= 0x3<<18,	/* endpoint type */
		...
		Epbulk	= 2<<18,
		Epintr	= 3<<18,
	Multicnt	= 0x3<<20,	/* transactions per μframe or retries per periodic split */
		OMulticnt = 20,
...
/* hcsplt */
	Prtaddr		= 0x7f<<0,	/* port address of recipient transaction translator */
	Hubaddr		= 0x7f<<7,	/* dev address of transaction translator's hub */
		OHubaddr=7,
