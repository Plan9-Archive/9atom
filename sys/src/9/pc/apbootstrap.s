...
TEXT _appdb(SB), 1, $0				/* address APBOOTSTRAP+0x0C */
	LONG $0
TEXT _apapic(SB), 1, $0				/* address APBOOTSTRAP+0x10 */
	LONG $0
TEXT _apbootstrap(SB), 1, $0			/* address APBOOTSTRAP+0x14 */
	MOVW	CS, AX
 ...
 */
TEXT _ap32(SB), 1, $0
	MOVL	_appdb-KZERO(SB), CX		/* physical address of page directory */
