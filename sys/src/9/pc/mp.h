...
extern char *apicmode(void);
extern uint apicinitdest(Apic*, int);
extern uint ioapicdest(Apic*, uint, uint*);

extern void ioapicinit(Apic*, int);
extern void ioapicmask(Apic*, int, int);
...
extern void lapicsetmasks(Apic*, int);
...
extern void mpgo(Apic*, int);
extern void mpinit(void);
extern int mpintrenable(Vctl*);
extern int mpintrdisable(Vctl*);
extern void mpshutdown(void);
extern void ioapicshutdown(void);
...
extern	int	mpisabus;
extern	Bus	*mpbus;
extern	Apic mplapic[MaxAPICNO+1];
extern	Apic mpioapic[MaxAPICNO+1];
extern	Apic *procvec[MaxAPICNO+1];
