...
#define	pe820tab		(CONFADDR - KZERO + 0x20)	/* PADDR(CONFADDR) */
#define	e820tab		(CONFADDR + 0x20)		/* CONFADDR */
#define	e820sz		20
#define maxe820		32
#define	e820end		(maxe820*e820sz+e820tab)
#define	pe820end	(maxe820*e820sz+pe820tab)
