...
static	void			colormap1(Header*, int, Rawimage*, int*, int, uint);
static	void			colormapall1(Header*, int, Rawimage*, int*, int*, int*, int, uint);
static	void			colormap(Header*, int, Rawimage*, int**, int**, int**, int, uint, uint, uint, int*, int*);
...
static
void
colormap1(Header *h, int colorspace, Rawimage *image, int data[8*8], int mcu, uint nacross)
{
	uchar *pic;
...
static
void
colormapall1(Header *h, int colorspace, Rawimage *image, int data0[8*8], int data1[8*8], int data2[8*8], int mcu, uint nacross)
{
...
static
void
colormap(Header *h, int colorspace, Rawimage *image, int *data0[8*8], int *data1[8*8], int *data2[8*8], int mcu, uint nacross, uint Hmax, uint Vmax,  int *H, int *V)
{
