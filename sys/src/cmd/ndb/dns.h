...
int	outsidens(int n, uchar[]);

/* dns.c */
char*	walkup(char*);
RR*	getdnsservers(int);
void	logreply(char*, int, uchar*, DNSmsg*);
void	logsend(char*, int, int, uchar*, char*, char*, int);
void	logtrunc(char*, char*, int, int, uchar*, char*, char*, int);
void	procsetname(char *fmt, ...);

/* dnresolve.c */
RR*	dnresolve(char*, int, int, Request*, RR**, int, int, int, int*);
int	udpport(char *);
int	mkreq(DN *dp, int type, uchar *buf, int flags, ushort reqno, int edns);
int	seerootns(void);
