...
//	Bprint(&bout, "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n");
	...
	Bprint(&bout, "<link rel=\"StyleSheet\" href=\"/manstyle.css\">\n");
	Bprint(&bout, "</head>\n");
...
trailer(void)
{
	...
	Bprint(&bout, "<form method=\"GET\" action=\"/magic/man2html\">\n");
	Bprint(&bout, "<input name=\"pat\" TYPE=\"text\" size=\"60\">\n");
	Bprint(&bout, "<input type=\"submit\" value=\"search\">\n");
	Bprint(&bout, "</form>\n");
...
/* match \([0-9]+[a-z]*\); this allows adr(9nix)*/
int
ckmanref(char *buf, int nbuf, char *s)
{
	int i;
