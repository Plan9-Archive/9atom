...
//	.clockctl	= PHYSIO+0x1004c,	/* unused */
	...
	.etherirq		= { IRQ0gbe0sum, IRQ0gbe1sum, },
...
{
	if(ctlno >= nelem(soc.ether))
		return -1;
	ether->type = "88e1116";
	ether->mem = soc.ether[ctlno];
	return 1;
}
...
int	flashat(Flash *f, uintmem pa);
