...
{
	struct {
		u32int	irq;		/* main intr cause reg (ro) */
		u32int	irqmask;
		u32int	fiqmask;
		u32int	epmask;
	} lo, hi;
...
struct CpucsReg
{
	...
	u32int	rstout;
	u32int	softreset;
	u32int	irq;		/* mbus(-l) bridge interrupt cause */
	u32int	irqmask;	/* ⋯ mask */
	u32int	mempm;		/* memory power mgmt. control */
	u32int	clockgate;	/* clock enable bits */
	u32int	biu;
	u32int	pad0;
	u32int	l2cfg;		/* turn l2 cache on or off, set coherency */
	u32int	pad1[2];
	u32int	l2tm0;
	u32int	l2tm1;
	u32int	pad2[2];
...
struct Pciex {
	u16int	venid;			/* 0x11ab means Marvell */
	u16int	devid;			/* 0x6281 means 6281 */
	u32int	csr;
	u32int	revid;
	u32int	bistcache;		/* bist hdr type & cache-line size */
	u32int	bar0;
	u32int	bar0hi;
	u32int	bar1;
	u32int	bar1hi;
	...
	u32int	bar2hi;
	u32int	_pad0;
	u16int	ssvenid;		/* 0x11ab means Marvell */
	u16int	ssdevid;		/* 0x11ab means Marvell */
	u32int	rombar;
	u32int	caplist;
	u32int	_pad1;
	u32int	intrpinline;		/* interrupt pin & line */
	u32int	pmcap;			/* power mgmt. capability header */
	u32int	pmcsr;			/* power mgmt. control & status */
	u32int	_pad2[2];
	u32int	msictl;			/* msi message control */
	u32int	msiaddr;
	u32int	msiaddrhi;
	u32int	msidata;
	u32int	cap;
	...
	u32int	errrep;			/* advanced error report header */
	u32int	uncorrerr;		/* uncorrectable error status */
	u32int	uncorrerrmask;		/* uncorrectable error mask */
	u32int	uncorrerrsev;		/* uncorrectable error severity */
	u32int	correrr;		/* correctable error status */
	u32int	correrrmask;		/* correctable error mask */
	u32int	errcap;			/* advanced error capability & ctl. */
	u32int	hdrlog[4];		/* header log */
