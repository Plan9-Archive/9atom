...
extern	void*	mallocalign(usize, usize, long, usize);
extern	void	setmalloctag(void*, ulong);			/* compatability with /sys/include/libc.h */
extern	void	setrealloctag(void*, ulong);			/* compatability with /sys/include/libc.h */
